...
export const ChatItem = ({
  ...
  return (
    <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
      ...
      {canDeleteMessage && (
        <div
          className="hidden group-hover:flex items-center gap-x-2 absolute p-2 -top-2 right-5
          ...
          {canEditMessage && (
            <ActionTooltip label="Edit">
              <Edit
                ...
                className="cursor-pointer ml-auto h-4 w-4 text-zinc-500 hover:text-zinc-600
